...
Product.destroy_all
p1 = Product.create :name => "Beer", :image => 'http://www.pizznlove-valdisere.com/wp-content/uploads/2014/02/peroni-nastro-azzuro.png', :inventory => 97, :unit_cost_price => 2.0, :description => "this is a peroni", :price_regular => 5.0
p2 = Product.create :name => "Wine", :image => 'https://www.wineselectors.com.au/images/sites/1/products/6B7DEAD9-877F-4B7E-8AAC-79737FABAD84/TAYLO30314-bottle.png' , :inventory => 48, :unit_cost_price => 5.0, :description => "this is a merlot", :price_regular => 15.0
